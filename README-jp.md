...
- EPUB 内部のフォルダー、XHTML、OPF、CSS、画像ファイル名を、`item/standard.opf`、`navigation-documents.xhtml`、`p-cover.xhtml`、`p-toc.xhtml`、`p-fmatter-001.xhtml`、`p-001.xhtml`、`p-colophon.xhtml`、`book-style.css`、`style-reset.css`、`image/cover.ext`、`image/i-001.ext`、`image/p-001.ext` のような規則的な名前にします。
